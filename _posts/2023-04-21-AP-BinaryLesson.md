...
categories: [week30]
permalink: /week30/lesson
type: ap
week: 30
nb_path: _notebooks/2023-04-21-AP-BinaryLesson.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2023-04-21-AP-BinaryLesson.ipynb
-->
...
<li>Complete all of the popcorn hacks (Fill in the blanks + run code cells and interact) [0.2 or nothing]</li>
<li>Create a program to conduct basic mathematical operations with binary sequences (addition, subtraction, multiplication, division) [0.7 or nothing]<ul>
