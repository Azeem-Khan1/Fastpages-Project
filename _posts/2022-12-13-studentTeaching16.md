---
keywords: fastai
description: Student Teaching Notes and Homework (3.16)
title: Student Teaching Lesson 3.16
layout: default
comments: true
toc: true
permalink: /lesson16
categories: [Student Teaching Portfolio]
nb_path: _notebooks/2022-12-13-studentTeaching16.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-12-13-studentTeaching16.ipynb
-->
...
<h2 id="My-simulation">My simulation<a class="anchor-link" href="#My-simulation"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># This is my simulation</span>
<span class="c1"># It simulates an n-sided dice being rolled and outputs what was rolled</span>

<span class="kn">import</span> <span class="nn">random</span>

<span class="k">def</span> <span class="nf">roll_dice</span><span class="p">(</span><span class="n">n</span><span class="p">):</span>
  <span class="k">return</span> <span class="n">random</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="n">n</span><span class="p">)</span>

<span class="n">sides</span> <span class="o">=</span> <span class="nb">float</span><span class="p">(</span><span class="nb">input</span><span class="p">(</span><span class="s2">&quot;How many sides would you like the dice to have?&quot;</span><span class="p">))</span>

<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;You rolled a(n)&quot;</span><span class="p">,</span> <span class="n">roll_dice</span><span class="p">(</span><span class="n">sides</span><span class="p">))</span>

<span class="c1"># For the output below, I set sides = 8</span>
</pre></div>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Example-of-a-simulation">Example of a simulation<a class="anchor-link" href="#Example-of-a-simulation"> </a></h2><p>This is 3dtuner.com</p>
<p><img src="/fastpages-project/images/copied_from_nb/../images/carsim.jpg" alt=""></p>
<p>It's a car simulation that lets you modify any car in their system. There are vast options for modification such as the car's body, interior, exhaust, engine parts, etc...</p>
<p>I enjoy using it because I like cars a lot.</p>
<p>This is a simulation because it shows the user a theoretical output based on options that the user chooses</p>
